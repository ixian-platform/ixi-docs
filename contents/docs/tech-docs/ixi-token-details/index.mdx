...
Offering a strong incentive to run Ixian Nodes is essential in maintaining the Ixian network. This incentive arrives in the form of $IXI, a cryptocurrency designed for micro transactions.
